...
/// </summary>
/// <remarks>
/// Inherit from <see cref="NotificationHandler{TNotification}"/> (or from
/// <see cref="DomainEventHandler{TEvent}"/>) instead of implementing this interface directly, so the
...
/// INotificationHandler&lt;IDomainEvent&gt;) is not invoked for derived notifications.
/// </remarks>
