...
public static class ConfigurationExtensions
{
    ...
    /// Cuando la sección de configuración especificada no se encuentra en el app.Settings.json.
    /// </exception>
    /// <remarks>
    /// This method will never return <c>null</c>. If no matching sub-section is found with the specified key, an empty
    /// <see cref="IConfigurationSection"/> will be returned.
    /// </remarks>
